export default function Footer() {
  return (
    <footer className="bg-gradient-to-r from-blue-500 to-purple-600 text-white border-t border-blue-400 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            <div className="flex items-center space-x-3 mb-4">
              ...
              <div>
                <h3 className="text-xl font-bold text-white">EcoStore</h3>
                <p className="text-xs text-white/80 font-medium">SUSTAINABLE LIVING</p>
              </div>
            </div>
            <p className="text-white/80">
              Your one-stop shop for eco-friendly products and sustainable living solutions.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-white/80">
              ...
              <li>
                <a href="/contact" className="hover:text-white transition-colors duration-200 flex items-center">
                  <span className="w-1 h-1 bg-white rounded-full mr-2"></span>
                  Contact
                </a>
              </li>
